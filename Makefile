...
files-install:
	...
	install --mode=644 usb_modeswitch.cfg $(ETCDIR)/usb_modeswitch.cfg
	...
	mkdir -p $(RULESDIR)
	install --mode=644 40-usb_modeswitch.rules $(RULESDIR)/40-usb_modeswitch.rules
